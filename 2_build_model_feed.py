...
opp_df = opp_df.drop_duplicates(subset=['Date', 'Team'])  # ✅ Prevents explosion
...
# ========== Save ==========
df.to_sql("model_feed", con=engine, if_exists="replace", index=False)
print("✅ Enriched model feed saved to 'model_feed' table in footy.db (leak-safe)")
