...
class TeamPrecompute(Base):
    ...
    score_avg_last_3 = Column("score_avg_last_3", Float, nullable=True)
    score_avg_last_5 = Column("score_avg_last_5", Float, nullable=True)
    score_avg_last_10 = Column("score_avg_last_10", Float, nullable=True)
    score_avg_home_last_5 = Column("score_avg_home_last_5", Float, nullable=True)
    score_avg_away_last_5 = Column("score_avg_away_last_5", Float, nullable=True)
